...
namespace DVCP.ViewModel
{
    ...
    public enum Dynasty
    {
        ...
        Timeline = 0,
        //1.. etc
        [Display(Name = "Tin tức nổi bật")]
        HongBang = 1,
        [Display(Name = "Tin tức thời sự ")]
        Dinh = 2,
        [Display(Name = "Tin tức bóng đá")]
        Early_Le = 3,
        [Display(Name = "Tin tức xã hội")]
        Ly = 4,
        [Display(Name = "Tin tức chính trị")]
        Tran = 5,
        [Display(Name = "Tin tức giải trí")]
        Later_Le = 6,
        [Display(Name = "Tin tức hàng tuần")]
        LeTrungHung = 7,
        [Display(Name = "Tin tức trong ngày")]
        TaySon = 8,
        [Display(Name = "Tin tức trong tháng")]
        Nguyen = 9,
        [Display(Name = "Tin tức khác")]
        Khac = 10,
    }
